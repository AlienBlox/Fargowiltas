...
// Type: Fargowiltas.Items.Explosives.Instavator
...
namespace Fargowiltas.Items.Explosives
{
  public class Instavator : ModItem
  {
    ...
    public virtual void SetDefaults()
    {
      ...
      this.Item.shoot = ModContent.ProjectileType<InstaProj>();
      this.Item.shootSpeed = 5f;
    }

    public virtual void AddRecipes()
    {
      this.CreateRecipe(1).AddIngredient(167, 50).AddIngredient(985, 10).AddIngredient(8, 99).AddIngredient(75, 3).AddTile(16).Register();
    }
  }
}
