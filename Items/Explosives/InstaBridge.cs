...
// Type: Fargowiltas.Items.Explosives.InstaBridge
...
namespace Fargowiltas.Items.Explosives
{
  public class InstaBridge : ModItem
  {
    ...
    public virtual void SetDefaults()
    {
      ...
      this.Item.shoot = ModContent.ProjectileType<InstabridgeProj>();
    }
    ...
    {
      this.CreateRecipe(1).AddIngredient(167, 10).AddIngredient(94, 1000).AddIngredient(75, 3).AddTile(16).Register();
    }
  }
}
