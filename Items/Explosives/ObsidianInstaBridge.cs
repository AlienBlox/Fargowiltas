...
// Type: Fargowiltas.Items.Explosives.ObsidianInstaBridge
...
namespace Fargowiltas.Items.Explosives
{
  public class ObsidianInstaBridge : ModItem
  {
    ...
    public virtual void SetDefaults()
    {
      ...
      this.Item.shoot = ModContent.ProjectileType<ObsInstabridgeProj>();
    }
    ...
    {
      this.CreateRecipe(1).AddIngredient(167, 10).AddIngredient(1457, 1000).AddIngredient(75, 3).AddTile(16).Register();
    }
  }
}
